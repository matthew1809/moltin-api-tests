...
func GenericRequest(wg *sync.WaitGroup, ID int, path string, client http.Client, method string, payload io.Reader, token string, name string, expectedCode int) []byte {
	defer wg.Done()
